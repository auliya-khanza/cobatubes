<!DOCTYPE html>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Dashboard Admin - Tambah Merchandise</title>
...
<body>
	...
	<form action="/merchandise/submit_merchan" method="POST">
		{{@csrf_field()}}
		<table>
            <tr>
				<td> ID </td>
				<td> : </td>
				<td> <input type="text" name="id" required="required"></textarea> </td>
			</tr>
			<tr>
				<td> Nama </td>
				<td> : </td>
				<td> <input type="text" name="nama" required="required"></textarea> </td>
			</tr>
			<tr>
				<td> Harga </td>
				<td> : </td>
				<td> <input type="text" name="harga" required="required"></textarea> </td>
			</tr>
			<tr>
				<td> Stok </td>
				<td> : </td>
				<td> <input type="text" name="stok" required="required"></textarea> </td>
			</tr>
			<tr>
				<td> Deskripsi </td>
				<td> : </td>
				<td> <input type="text" name="deskripsi" required="required"></textarea> </td>
			</tr>
            <!-- <tr>
				<td>Upload gambar</td>
				<td>:</td>
				<td><input type="file" name="image_merchandise" ></input> </td>
			</tr> -->
			<tr>
